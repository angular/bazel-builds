...
(function (factory) {
    ...
    if (require.main === module) {
        ...
        var _a = (0, tslib_1.__read)(process.argv.slice(2), 3), tsConfig = _a[0], entryPoint = _a[1], dtsBundleOut = _a[2];
