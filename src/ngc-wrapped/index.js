...
(function (factory) {
    ...
    function compile(_a) {
        ...
        bazelHost.shouldNameModule = function (fileName) {
            var flatModuleOutPath = path.posix.join(bazelOpts.package, compilerOpts.flatModuleOutFile + '.ts');
